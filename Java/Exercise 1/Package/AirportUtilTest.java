...
public class AirportUtilTest {
    ...
    public static void main(String[] args) {
        ...
        // Creates an array of Package.Movable objects
        Movable[] movables = new Movable[TOTAL * 2];

        //initializes an array of Package.Movable objects (trains and planes)
    ...
    public static void printPlanes(Plane [] planes){
        for (int i = 0; i < TOTAL; i++) {
            System.out.println("Details about Package.Plane number " + (i + 1));
